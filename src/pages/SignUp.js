      ...
      <div className="flex flex-col w-full px-4 mx-4">
        <div className="mt-20">
          <h1 className="text-xl">
            ...
            <span className="font-bold">Sign Up</span> to unlock all the option
          </h1>
        </div>
        <form className="mt-6">
          ...
          <div className="flex">
            <button className="flex w-full border border-[#4971BD] bg-white text-[#4971BD] font-semibold rounded-full py-3 justify-center items-center hover:bg-blue-100 transition-colors duration-300">
        ...
        <div className="flex flex-col w-[480px] mx-4 px-12 shadow-xl rounded-3xl">
          <div className="mt-12">
            ...
            <h1 className="text-2xl">
              ...
              <div>
                <span className="font-bold">Sign Up to unlock all the option</span>
              </div>
            </h1>
          </div>
          <form className="mt-6">
