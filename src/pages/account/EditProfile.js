const EditProfile = () => {
  return (
    <div className="flex flex-col w-full">
      <div className="flex flex-row w-full justify-start items-center my-8 md:mt-0">
        <div className="bg-[url('/public/assets/avatar/xyz@anydomain.com.png')] bg-cover bg-center w-16 h-16 rounded-full mr-4"></div>
        <div className="flex items-center text-lg text-blue font-semibold">Upload Profile Photo</div>
      </div>
