  ...
  return (
    <div className="flex flex-col w-full mt-8 md:mt-0">
      ...
      <button
        ...
        className="flex w-fit bg-white text-red font-semibold border border-red rounded-full py-2.5 px-6 justify-center items-center hover:bg-red hover:text-white transition duration-300"
      >
        Delete Account
      </button>
